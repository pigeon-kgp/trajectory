...
function plotTraceJSON_f4(){
   ...
   var color = fileloc_index_4(fileName);
	
	
	
     getInformation_feature4(URL, color);



}

var fileloc_index_4 = function(key){
...
var getInformation_feature4 = function(filepath, color) { 
  var path = filepath;
